...
export default function define(runtime, observer) {
  ...
  main.variable(observer("intro")).define(["md"], _1);
  ...
  main.variable(observer("globe")).define(["d3","size","styles","graticule","countries","zones","color","path","projection","filteredDestinations","categoryColorLookup","destinationCategories","destinationInfoPanel","invalidation"], _4);
  main.variable(observer("inspo")).define(["md"], _5);
  main.variable(observer()).define(["md"], _6);
  main.variable(observer()).define(["md"], _7);
  main.variable(observer("destinationsIntro")).define(["md"], _destinationsIntro);
